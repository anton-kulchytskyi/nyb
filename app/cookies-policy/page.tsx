  ...
  return (
    <div className="info-page">
      ...
      <section className="info-page__section">
        ...
        <h4 className="info-page__section__text">We use cookies on our Website to:</h4>
      ...
      <section className="info-page__section">
        ...
        <h4 className="info-page__section__text">We use the following types of cookies on our Website:</h4>
        <ul className="info-page__section__list">
      ...
      <p className="info-page__section">
        For more information about cookies and how to control them, please visit the following website: <a href="http://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="info-page__link">allaboutcookies.org</a>
      </p>
      <section className="info-page__section">
        <h3 className="info-page__section__header">Changes to Our Cookie Policy</h3>
        <p className="info-page__section__text">
      ...
      <section className="info-page__section">
        ...
        <p className="info-page__section__text">
          If you have any questions about this Policy, please contact us at <a href="mailto:info@norseyacht.com" className="info-page__link">info@norseyacht.com</a>
        </p>
      </section>
    </div>
  )
