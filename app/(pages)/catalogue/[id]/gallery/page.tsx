...
import {FreeMode, Scrollbar, Mousewheel, Navigation, Thumbs} from 'swiper/modules';
    ...
    <div className={styles.container}>
      ...
      <div className={styles.gallery__container}>
              ...
              {({isActive}) => (
                [...images, ...images].map((img, index) => (
                  <img
                    ...
                    src={img}
                    alt="yacht"
                    className={`${styles.swiper_small__image} ${isActive ? styles.kek : ''}`}
                  />
                )))}
            </SwiperSlide>
          </Swiper>
        ...
        <div className={styles.gallery_big}>
          <p className={styles.gallery_big__info}>{vessel.yacht_model} <Button text='Buy now' linkTo='/' primary /></p>
          <Swiper
            direction={'vertical'}
            slidesPerView={'auto'}
            mousewheel={true}
        ...
        <div className={styles.info}>
          <div className={styles.info__top}>
            <span className={styles.info__top__title}>
              {vessel.yacht_model}, {vessel.yacht_year},
              {vessel.yacht_country}, {vessel.yacht_town}
            </span>
            <Image
              width={24}
              height={24}
          ...
          <div className={styles.info__body_featchures}>
            <section className={styles.info__body_item__container}>
              ...
              <p className={`${styles.info__body_item} ${styles.orange}`}>{`${selectedCurrencySymbol} ${currPrice}`}</p>
            </section>
            <section className={styles.info__body_item__container}>
            ...
            <section className={styles.info__body_item__container}>
              ...
              <p className={styles.info__body_item}>{vessel.yacht_keel_type}</p>
            </section>
            <section className={styles.info__body_item__container}>
              <p className={styles.info__body_title}>Fuel Type:</p>
              <p className={styles.info__body_item}>{vessel.yacht_fuel_type}</p>
            </section>
            <section className={styles.info__body_item__container}>
